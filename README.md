...
Breadboard build:
<img src="images/breadboard-testing-2.jpg" alt="Testing the circuit on a breadboard" height="150"/>

Testing with oscilloscope:
<img src="images/pulse-signal.jpg" alt="Oscilloscope output" height="150"/>

Sizing up PCB from breadboard layout:
<img src="images/breadboard-to-circuitboard-size-compare.jpg" alt="Size comparison for layout of PCB" height="150"/>

## V.0 Design

Below are 2D and 3D renders of the v.0 design:

<img src="images/ciruitboard-v0.png" alt="PCB v.0 2D render" height="150"/>

<img src="images/electroporator_v0_3D_render.png" alt="PCB v.0 3D render" height="150"/>
...
<img src="images/jst_only.jpg" alt="JST only version" height="150"/>
...
<img src="images/jst_only-mid_range.png" alt="JST only mid-range version" height="150"/>
...
<img src="images/no_current_regulator.png" alt="JST no current regulator" height="150"/>
...
<img src="images/kilovolt_max.png" alt="Kilo-volt compatible design" height="150"/>
...
<img src="images/project-box-lid-cutout.jpg" height="150"/>

<img src="images/project-box-lid-cutouts-inside.jpg" height="150"/>

<img src="images/project-box-lid-upsidedown.jpg" height="150"/>

#### Sides:

<img src="images/project-box-inside.jpg" height="150"/>

<img src="images/project-box-front-side-cutouts.jpg" height="150"/>

<img src="images/project-box-all-side-cutouts.jpg" height="150"/>

<img src="images/project-box-power-cutout.jpg" height="150"/>

#### Lid IO:

<img src="images/project-box-lid-IO.jpg" height="150"/>

<img src="images/project-box-lid-IO-inside.jpg" height="150"/>

#### Sides IO:

<img src="images/project-box-inside-with-side-IO.jpg" height="150"/>

<img src="images/project-box-front-side-IO.jpg" height="150"/>

<img src="images/project-box-all-side-IO.jpg" height="150"/>

<img src="images/project-box-power-IO.jpg" height="150"/>

<img src="images/project-box-power-plug-inside.jpg" height="150"/>
...
<img src="images/project-box-IO-layout-test.jpg" height="150"/>

#### Power supply:

<img src="images/project-box-power-supply-wiring.jpg" height="150"/>

<img src="images/project-box-power-supply-wiring-closeup.jpg" height="150"/>

Yellow & black for 5V, red and black for variable power output...
<img src="images/project-box-power-dual-internal-voltages.jpg" height="150"/>

#### Power IO:

Includes the LED for indicating when the pulse occurs...
<img src="images/project-box-power-IO-wiring.jpg" height="150"/>

IO with wires attached and organized...
<img src="images/project-box-internal-IO-wiring.jpg" height="150"/>

Power IO removed from lid for next step...
<img src="images/project-box-internal-IO-wiring-1.jpg" height="150"/>

#### PCB:

<img src="images/electroporator-pcb.jpg" height="150"/>

Power (5V and electrode variable), electrodes, and the electrode test button wiring...
<img src="images/electroporator-pcb-major-wiring.jpg" height="150"/>

Power switch, pulse duration potentiometer, and pulse LED indicator control wiring...
<img src="images/electroporator-pcb-control-wiring.jpg" height="150"/>

All PCB connections in place in box...
<img src="images/electroporator-pcb-wired-in-situ.jpg" height="150"/>

Cleaned up the lid wiring...
<img src="images/project-box-final-clean-wiring.jpg" height="150"/>

### Small project box

<img src="images/mini-pcb-in-situ.jpg" height="150"/>

<img src="images/mini-power-5v-split.jpg" height="150"/>

<img src="images/mini-5v-convert.jpg" height="150"/>

<img src="images/mini-power-supply-and-parts.jpg" height="150"/>

<img src="images/mini-final.jpg" height="150"/>

<img src="images/mini-final-1.jpg" height="150"/>
